...
<div class="lajmi1">
  ...
  <img src="/images/razer.jpg" class="foto1" style="border-radius: 10px;" alt="Razer">
  <h2 class="hlajmi1"><a href="3.1.html">Viti 2023 do të jetë viti i shfaqjes <br> per pajisjet teknologjike</a></h2><p class="plajmi1">Razer's Blade 16 është vetëm një nga laptopët e lojërave me ekrane të zbukuruara që vjen në vitin 2023. Laptopët e vitit 2023 do të kenë çipa të rinj dhe grafika të reja. Shumë do të marrin tastierë të rinj me prekje, disa do të kenë fansa të rinj dhe disa do të marrin majë shkruese të tmerrshme. Por disa nga përditësimet më të bukura, më të çuditshme dhe më emocionuese po vijnë në ekrane...</p>
  </div>
<hr>
<div class="lajmi2">

  <img src="/images/shanghai.jpg" class="foto" style="border-radius: 10px;" alt="Shanghai">
  <h6 class="hlajmi2"><a href="3.2.html">Spiunazhi industrial: Si Kina nxjerr fshehtas sekretet teknologjike të Amerikës</a></h6><p class="plajmi3">Ishte një fotografi me pamje të padëmshme që doli të ishte rënia e Zheng Xiaoqing,<br> një ish-punonjës i konglomeratit të energjisë General Electric <br> Power.
    Sipas një aktakuze të Departamentit...</p>
...
<div class="lajmi3">
  ...
  <img src="/images/tiktok.jpg" class="foto" style="border-radius: 10px;" alt="Tiktok">
  <h6 class="hlajmi3"><a href="3.3.html">TikTok shpërndan etiketën e tij 'media e kontrolluar nga shteti' në 40 vende të tjera</a></h6><p class="plajmi3">   TikTok njoftoi sot se po zgjeron etiketën e tij "media e kontrolluar nga shteti" në më <br>
    shumë se 40 tregje të tjera globale, për të paralajmëruar <br>  përdoruesit kur videot që po shohin në...
    </p>
...
<div class="tabelat">
  <table border="1">
      <tr>
          <td ><a href="/html/news.html">1</a></td>
