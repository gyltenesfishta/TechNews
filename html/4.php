...
<div class="lajmet12">
  <div class="lajmi1">
        ...
        <img src="/images/tesla.jpg" class="foto1" style="border-radius: 10px;" alt="TeslaHQ">
        <h2 class="hlajmi1"><a href="4.1.html">Inxhinieri i Tesla-s i thotë gjykatës se firma organizoi video të vitit 2016 duke promovuar aftësitë e vetëdrejtimit</a></h2><p class="plajmi1"> Një video e vitit 2016 që Tesla përdori për të promovuar teknologjinë e saj vetë-drejtuese u inskenua për të treguar aftësi si ndalimi në një dritë të kuqe dhe përshpejtimi në një dritë jeshile që sistemi nuk e kishte, sipas dëshmisë nga një inxhinier i lartë
          Videoja, e cila mbetet e arkivuar në faqen e internetit të Teslës, u publikua në tetor 2016 dhe u promovua në Twitter...
        </p>
        </div>
  <hr>
  <div class="lajmi2">

        <img src="/images/bio.jpg" class="foto" style="border-radius: 10px;" alt="Bio Robot">
        <h6 class="hlajmi2"><a href="4.2.html"> Sensori biologjik lejon robotin të zbulojë erërat</a></h6><p class="plajmi3">Studiuesit e Universitetit të Tel Avivit kanë arritur <br> një përparim teknologjiko-biologjik <br>duke bërë të mundur që një...</p>
  ...
  <div class="lajmet34">
    <div class="lajmi3">
        <img src="/images/media.jpg" class="foto" style="border-radius: 10px;" alt="Media">
        <h6 class="hlajmi3"><a href="4.3.html">Shefat e Big Tech përballen me ndjekje penale në projektligjin e ndryshuar të sigurisë në internet</a></h6> <p class="plajmi3"> Drejtuesit e teknologjisë, platformat e të cilëve vazhdimisht <br>
          dështojnë në mbrojtjen e fëmijëve nga dëmtimi <br>
           në internet, mund të përballen...
