...
<form method="post" action="shto-lajmin-logic.php" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="text" name="titulli" class="form-control" id="exampleInputEmail1" aria-describedby="titulli" required style= "border-color: black; background-color: #e0e0e0;">
    ...
    <textarea class="form-control" name="permbajtja" id="exampleFormControlTextarea1" rows="25" required style= "border-color: black; background-color: #e0e0e0;"></textarea>
